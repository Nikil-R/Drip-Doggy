...
import { Mail, Smartphone, ArrowRight, User } from "lucide-react";
...
export function AuthModal() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 backdrop-blur-xl bg-black/50 transition-all duration-300">
      <div className="w-full max-w-md bg-[#FAF8F5] border border-neutral-250/90 shadow-[0_10px_40px_rgba(0,0,0,0.2)] p-8 md:p-10 relative flex flex-col justify-between">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[9px] font-extrabold tracking-[0.3em] text-neutral-455 uppercase">
              {step === "identifier" ? "Drip Portal" : step === "otp" ? "Verification" : "Complete Profile"}
            </span>
            <div className="h-px flex-1 bg-neutral-200" />
          </div>
          {step === "identifier" ? (
            <>
              <h1 className="text-2xl md:text-3xl font-extrabold tracking-[0.05em] text-center uppercase text-neutral-900 leading-tight">
                Access The Syndicate
              </h1>
              <p className="text-neutral-500 text-xs tracking-wide text-center mt-3 font-medium">
                Enter your email address to continue browsing our collections.
              </p>
            </>
          ) : step === "otp" ? (
            <>
        ...
        {step === "identifier" && (
          <form onSubmit={handleSendOtp} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-[#030213] hover:bg-neutral-800 disabled:bg-neutral-200 text-white disabled:text-neutral-400 py-4 text-[10px] font-extrabold tracking-widest uppercase transition-all duration-250 flex items-center justify-center gap-2.5 border-none cursor-pointer"
            >
