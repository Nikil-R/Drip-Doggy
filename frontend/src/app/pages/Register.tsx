              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-neutral-200 pl-9 pr-3.5 py-3 text-sm focus:outline-none focus:border-[#030213] transition-all duration-200 rounded-none text-neutral-900 placeholder-neutral-400"
                  />
                </div>
                <div>
                  <input
                    ...
                    className="w-full bg-white border border-neutral-200 px-3.5 py-3 text-sm focus:outline-none focus:border-[#030213] transition-all duration-200 rounded-none text-neutral-900 placeholder-neutral-400"
                  />
                </div>
              </div>
