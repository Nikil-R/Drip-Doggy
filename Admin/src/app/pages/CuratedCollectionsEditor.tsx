...
import { Plus, Trash2, Edit2, X, RotateCcw, Check, AlertTriangle, ArrowUp, ArrowDown, Layers } from "lucide-react";
import {
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-neutral-200 px-3 py-2 text-[9px] font-mono focus:outline-none focus:border-[#224870] rounded-none bg-white text-neutral-600"
                />
                <p className="text-[7px] text-neutral-400 mt-1">Recommended: 600×400px landscape image (3:2 aspect ratio)</p>
              </div>
