  ...
  return (
    <div className="space-y-8 font-sans">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-black text-[#030213] uppercase tracking-widest">Signature Pieces</h1>
      ...
      <div className="bg-white border border-neutral-200/80 p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
