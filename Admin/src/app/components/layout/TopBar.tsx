...
export function TopBar() {
  ...
  const getPageTitle = () => {
    ...
    if (path.includes("/admin/returns")) return "Order Returns";
    if (path.includes("/admin/exchanges")) return "Order Exchanges";
    ...
    if (path.includes("/admin/content/collections")) return "Curated Collections Editor";
    if (path.includes("/admin/content/navigation")) return "Navigation Menu";
