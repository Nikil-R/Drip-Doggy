...
export function ProductDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#030213] font-sans antialiased selection:bg-neutral-200">
      ...
      {/* Premium Product Header Section */}
      <section className="max-w-7xl mx-auto px-6 pt-8 pb-0 flex items-center justify-between gap-4">
        {/* Breadcrumb Navigation */}
        <nav className="flex items-center gap-2 text-xs md:text-sm font-bold tracking-[0.2em] text-[#6B7280] uppercase" aria-label="Breadcrumb">
          <Link to="/" className="hover:underline hover:text-black transition-colors duration-150 cursor-pointer">
            Home
          </Link>
          <span className="text-[10px] text-neutral-450 select-none">&gt;</span>
          <Link to="/shop" className="hover:underline hover:text-black transition-colors duration-150 cursor-pointer">
            Women
          </Link>
          <span className="text-[10px] text-neutral-450 select-none">&gt;</span>
          <span className="text-neutral-500 select-none font-semibold truncate max-w-[150px] md:max-w-none">
        ...
        <button
          ...
          className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#F3F4F6] hover:bg-[#E5E7EB] text-neutral-800 flex items-center justify-center transition-all duration-200 cursor-pointer border-none shadow-sm hover:scale-105 active:scale-95 flex-shrink-0"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-8 lg:pl-6">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight mt-2 mb-3 leading-none uppercase">
                Structure Tactical Layer
              </h1>
              <p className="text-xs font-semibold text-[#374151] mb-6 uppercase tracking-wider">
                SKU: DD-WMN-STR-1001
              </p>
              
              <div className="flex items-center gap-4">
                <span className="text-2xl font-extrabold tracking-tight">£485.00</span>
            ...
            <div>
              <p className="text-xs font-extrabold tracking-[0.2em] text-neutral-400 mb-3 uppercase">
              ...
              <div className="flex gap-4 overflow-x-auto pb-1.5 scrollbar-none">
                {colors.map(color => (
                  <button
                    ...
                    className={`relative w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden border-2 transition-all duration-200 cursor-pointer flex-shrink-0 focus:outline-none ${
                      selectedColor === color.name 
                        ? "border-[#030213] scale-105 shadow-md ring-2 ring-offset-2 ring-neutral-950" 
            ...
            {/* Size Selector */}
            <div>
              <div className="flex justify-between items-baseline mb-3 max-w-md">
            ...
            <div className="flex items-center gap-4 py-1">
              ...
              <div className="flex items-center border border-neutral-200 rounded-sm px-2.5 py-1.5 bg-neutral-50/50 shadow-xs">
                <button
                  onClick={() => setQuantity(prev => Math.max(1, prev - 1))}
                  className="text-neutral-500 hover:text-neutral-900 px-2.5 font-bold text-sm"
                >
                  -
                </button>
                <span className="text-xs font-extrabold w-8 text-center text-neutral-800">{quantity}</span>
                <button
            ...
            <div ref={ctaSectionRef} className="grid grid-cols-2 gap-4 max-w-md pt-2">
              <button
                ...
                className="bg-[#030213] text-white py-4 rounded-sm text-xs font-extrabold tracking-[0.15em] hover:bg-neutral-800 transition-all uppercase shadow-md active:scale-[0.99] border-none"
              >
                ADD TO BAG
              </button>
              <button
                onClick={() => alert("Proceeding to checkout!")}
                className="bg-white text-black border border-[#030213] py-4 rounded-sm text-xs font-extrabold tracking-[0.15em] hover:bg-[#030213] hover:text-white transition-all uppercase active:scale-[0.99]"
              >
                BUY IT NOW
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-neutral-200/60 text-center max-w-md">
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-[8px] font-extrabold tracking-widest text-neutral-700 uppercase leading-snug">FREE SHIPPING</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-[8px] font-extrabold tracking-widest text-neutral-700 uppercase leading-snug">EXCHANGE AT STORE</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-[8px] font-extrabold tracking-widest text-neutral-700 uppercase leading-snug">EASY RETURNS</span>
              </div>
            </div>
      ...
      >
        ...
        <div className="hidden md:flex max-w-7xl mx-auto px-6 h-24 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            {/* Quantity Selector */}
            <div className="flex items-center gap-3 bg-white border border-neutral-200 rounded-sm px-2.5 py-1.5 shadow-xs">
              <button 
                onClick={() => setQuantity(prev => Math.max(1, prev - 1))}
                className="text-neutral-500 hover:text-neutral-900 font-bold text-xs px-1"
              >
                -
              </button>
              <span className="text-xs font-extrabold w-4 text-center text-neutral-800">{quantity}</span>
              <button 
                onClick={() => setQuantity(prev => prev + 1)}
                className="text-neutral-500 hover:text-neutral-900 font-bold text-xs px-1"
              >
            ...
            <div className="flex gap-3">
              <button
                onClick={handleAddToBag}
                className="w-[180px] h-[48px] bg-white text-black border border-[#030213] text-xs font-extrabold tracking-[0.15em] hover:bg-neutral-50 transition-all uppercase rounded-sm shadow-sm active:scale-[0.99]"
              >
                ADD TO BAG
              </button>
              <button
                onClick={() => alert("Proceeding to checkout!")}
                className="w-[180px] h-[48px] bg-[#030213] text-white text-xs font-extrabold tracking-[0.15em] hover:bg-neutral-800 transition-all uppercase rounded-sm shadow-md active:scale-[0.99]"
              >
                BUY NOW
              </button>
            </div>
        ...
        <div className="md:hidden p-3.5 space-y-3.5">
          ...
          <div className="grid grid-cols-2 gap-3.5">
            <button
              onClick={handleAddToBag}
              className="w-full h-[52px] bg-white text-black border border-[#030213] text-[10px] font-extrabold tracking-[0.15em] hover:bg-neutral-50 uppercase rounded-sm active:scale-[0.99]"
            >
              ADD TO BAG
            </button>
            <button
              onClick={() => alert("Proceeding to checkout!")}
              className="w-full h-[52px] bg-[#030213] text-white text-[10px] font-extrabold tracking-[0.15em] hover:bg-neutral-800 uppercase rounded-sm active:scale-[0.99]"
            >
              BUY NOW
            </button>
          </div>
